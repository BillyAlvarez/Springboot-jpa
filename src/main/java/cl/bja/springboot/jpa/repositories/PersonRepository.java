package cl.bja.springboot.jpa.repositories;

import cl.bja.springboot.jpa.dto.PersonDto;
...
public interface PersonRepository extends CrudRepository<Person, Long> {
    ...
    @Query("select new cl.bja.springboot.jpa.dto.PersonDto(p.name, p.lastname) from Person p")
